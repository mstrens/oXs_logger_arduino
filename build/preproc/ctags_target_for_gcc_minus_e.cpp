...
//        test if it is possible to use any gpio for cs
//        test with more data generated by oXs
//        test with rc channels
//        write file creation date/time when we get an initial GPS date and time (use timestamp()
//           bool file.timestamp(uint8_t T_CREATE, uint16_t year, uint8_t month, uint8_t day, uint8_t hour, uint8_t minute, uint8_t second )

# 19 "c:\\Data\\oXs_logger_arduino\\oXs_logger_arduino.ino" 2

//--------------for led + serialIn
# 22 "c:\\Data\\oXs_logger_arduino\\oXs_logger_arduino.ino" 2
# 23 "c:\\Data\\oXs_logger_arduino\\oXs_logger_arduino.ino" 2
# 24 "c:\\Data\\oXs_logger_arduino\\oXs_logger_arduino.ino" 2
# 25 "c:\\Data\\oXs_logger_arduino\\oXs_logger_arduino.ino" 2
# 26 "c:\\Data\\oXs_logger_arduino\\oXs_logger_arduino.ino" 2
